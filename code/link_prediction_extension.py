...
if __name__ == "__main__":
    ...
    results_dir = "./results/link_prediction_extension"
    for dataset in datasets:
        ...
        embed_settings = [
            ("default", "deepwalk", {}),
            ("fairwalk", "deepwalk", {}),
            ("crosswalk", "deepwalk", {"alpha": 0.5, "p": 2}),
        ]
        ...
        for reweight_method, embed_method, reweight_params in embed_settings:
            ...
            for iter in [str(k) for k in range(1, 6)]:
                ...
                emb = embed_utils.graph2embed(
                    new_G, reweight_method, embed_method, reweight_params
                )
                # model = DeepWalk()
                # model.fit(new_G)
            ...
            results_final = {
                "accuracies": results["average weighted accuracy"],
                "disparities": results["average disparity"],
                "degree_assortativity": r_d,
                "attribute_assortativity": r_a,
            }
            # change test
            filename = f"test_{reweight_method}.json"
